function drawLongNote(lane, x, y, yEnd) {
    ...
    const end = new PIXI.Sprite.from('longnote/' + noteHoldStart);
    const body = new PIXI.Sprite.from('longnote/' + noteHoldBody);
    const start = new PIXI.Sprite.from('longnote/' + NoteHoldEnd);
